package qa.vikindor.pages;

import com.codeborne.selenide.SelenideElement;
import qa.vikindor.pages.components.CalendarComponent;
...
public class PracticeFormPage {
    ...
    public PracticeFormPage shouldHaveRedBorder(String fieldName) {
        String redRgb = "rgb(220, 53, 69)";
        String redRgba = "rgba(220, 53, 69, 1)";

        switch (fieldName) {
            case "firstName"  -> firstNameInput.shouldHave(cssValue("border-color", redRgb));
            case "lastName"   -> lastNameInput.shouldHave(cssValue("border-color", redRgb));
            case "gender"     -> genderAnyLabel.shouldHave(cssValue("color", redRgba));
            case "userNumber" -> userNumberInput.shouldHave(cssValue("border-color", redRgb));
